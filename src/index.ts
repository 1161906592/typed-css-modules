...
const declareTemplate = (selectors: string[]) => `declare namespace AppCSSModuleNamespace {
...
export const getJSON: Parameters<PostcssModulesPlugin>[0]['getJSON'] = (cssFileName, modules) => {
